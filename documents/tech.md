...
```
    ...
    ##    <chr>              <dbl>          <dbl>
    ##  1 http://mashab~       731             13
    ##  2 http://mashab~       731             10
    ##  3 http://mashab~       731             12
    ##  4 http://mashab~       731             11
    ##  5 http://mashab~       731              8
    ##  6 http://mashab~       731             13
    ##  7 http://mashab~       731             11
    ##  8 http://mashab~       731              8
    ##  9 http://mashab~       731              8
    ## 10 http://mashab~       731             12
...
```
    ...
    ##  Mean   :  9.359   Mean   :  4.627  
    ##  3rd Qu.: 11.000   3rd Qu.:  6.000  
    ##  Max.   :119.000   Max.   :116.000  
    ##     num_imgs        num_videos     
    ##  Min.   : 0.000   Min.   : 0.0000  
    ##  1st Qu.: 1.000   1st Qu.: 0.0000  
    ##  Median : 1.000   Median : 0.0000  
    ##  Mean   : 4.336   Mean   : 0.4389  
    ##  3rd Qu.: 5.000   3rd Qu.: 1.0000  
    ##  Max.   :65.000   Max.   :73.0000  
    ##  average_token_length  num_keywords   
    ##  Min.   :0.000        Min.   : 2.000  
    ##  1st Qu.:4.424        1st Qu.: 6.000  
    ##  Median :4.593        Median : 8.000  
    ##  Mean   :4.578        Mean   : 7.751  
    ##  3rd Qu.:4.757        3rd Qu.: 9.000  
    ##  Max.   :5.857        Max.   :10.000  
...
```
    ...
    ## 7 Wednesd~  1004    36 663600 3561.   1600
...
```
    ...
    ## Summary of sample sizes: 4626, 4628, 4629, 4629, 4630, 4628, ... 
    ## Resampling results:
    ## 
    ##   RMSE      Rsquared     MAE     
    ##   7226.249  0.009983166  2415.875
    ## 
